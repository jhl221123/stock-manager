...
class PurchaseServiceTest {
	...
	void purchaseProductFailOutOfStockQuantity() {
		...
		//expected
		assertThrows(OutOfStockQuantityException.class, () -> purchaseService.purchase(singlePurchaseRequest));
	}
	...
	void purchaseProductFailNotFoundQuantity() {
		...
		//expected
		assertThrows(NotFoundProductException.class, () -> purchaseService.purchase(singlePurchaseRequest));
	}
}